...
![Fig.1 退化问题：更深网络的训练误差反而更高 =560x](/DeepLearning/Network/05_resnet_01.png)
...
![Fig.2 两种残差块结构对比 =660x](/DeepLearning/Network/05_resnet_02.png)
...
![Fig.3 ResNet-50：Conv1 → 4 个 Bottleneck Stage → GAP → FC =800x](/DeepLearning/Network/05_resnet_03.png)
...
@tab Bottleneck（ResNet-50/101/152）
