...
![Fig.2 特征复用：浅层学边缘，深层直接用，不需要重新学 =560x](/DeepLearning/Network/06_densenet_reuse.png)
...
![Fig.3 Inception Module 内部结构：4 个分支并联，最后拼接 =560x](/DeepLearning/Network/06_inception_module.png)
...
![Fig.4 GoogLeNet 完整架构：22 层，9 个 Inception Module =560x](/DeepLearning/Network/06_inception_arch.png)
...
![Fig.7 Inverted Residual Block 内部结构：升维→深度卷积→降维 =560x](/DeepLearning/Network/06_mobilenetv2_block.png)
...
![CNN 演进全景图 =560x](/DeepLearning/Network/06_cnn_timeline.png)
