...
![1.5 CUDA向后兼容 =360x](/DeepLearning/pytorch/01_base/01-05.png)

![1.6 CUDA小版本兼容 =360x](/DeepLearning/pytorch/01_base/01-06.png)
...
![1.7 CUDA向前兼容 =560x](/DeepLearning/pytorch/01_base/01-07.png)
...
![1.8 旧版本CUDA工具包 =360x](/DeepLearning/pytorch/01_base/01-08.png)

![1.9 新版本CUDA工具包 =360x](/DeepLearning/pytorch/01_base/01-09.png)
...
![1.10 PyTorch下载1 =360x](/DeepLearning/pytorch/01_base/01-10.png)

![1.11 PyTorch下载2 =360x](/DeepLearning/pytorch/01_base/01-11.png)
...
![1.12 虚拟环境中PyTorch的安装 =560x](/DeepLearning/pytorch/01_base/01-12.png)

@tab 验证是否安装成功

![1.13 验证PyTorch是否安装成功 =560x](/DeepLearning/pytorch/01_base/01-13.png)
