...
![2.1 公开数据集仓库 - UCI - 1 =560x](/DeepLearning/pytorch/02_classification/02-01.png)
...
![2.2 公开数据集仓库 - UCI - 2 =360x](/DeepLearning/pytorch/02_classification/02-02.png)

![2.3 公开数据集仓库 - UCI - 3 =360x](/DeepLearning/pytorch/02_classification/02-03.png)
...
![2.4 Kaggle平台 - 泰坦尼克号幸存者分类 =560x](/DeepLearning/pytorch/02_classification/02-04.png)
