...
![4.1 逻辑回归 =560x](/machinelearning/one/04-1.png)
...
![4.2 线性决策边界 =560x](/machinelearning/one/04-2.png)

![4.3 非线性决策边界 =560x](/machinelearning/one/04-3.png)
...
![4.4 平方误差代价函数 =560x](/machinelearning/one/04-4.png)
...
![4.5 非线性决策边界 =560x](/machinelearning/one/04-5.png)
...
![4.6 线性回归的过拟合例子 =560x](/machinelearning/one/04-6.png)

![4.7 分类问题的过拟合例子 =560x](/machinelearning/one/04-7.png)
...
![4.8 正则化 =560x](/machinelearning/one/04-8.png)
...
![4.9 正则化项lambda过大 =560x](/machinelearning/one/04-9.png)
...
![4.10 线性回归的正则化 =560x](/machinelearning/one/04-10.png)

## 5.逻辑回归的正则化（Regularized Logistic Regression）

![4.11 逻辑回归的正则化 =560x](/machinelearning/one/04-11.png)
