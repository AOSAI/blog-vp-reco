...
![3.1 特征缩放 =560x](/machinelearning/one/03-1.png)
...
![3.2 除以最大值 =560x](/machinelearning/one/03-2.png)
...
![3.3 均值归一化 =560x](/machinelearning/one/03-3.png)
...
![3.4 标准化 =560x](/machinelearning/one/03-4.png)

### 4.5 总结

我们要尽可能的保证特征区间在[-1,1]之间，如果过大，会导致提梯度下降过慢，太小也会导致梯度下降过快。看一看吴恩达教授举得一些例子：

![3.5 特征区间的选择 =560x](/machinelearning/one/03-5.png)
...
![3.6 判断梯度下降是否收敛 =560x](/machinelearning/one/03-6.png)

### 5.2 选择学习率（Choosing the Learning Rate）

![3.7 学习率的选择 =560x](/machinelearning/one/03-7.png)
...
![3.8 特征工程 =560x](/machinelearning/one/03-8.png)
...
![3.9 多项式回归 =560x](/machinelearning/one/03-9.png)
