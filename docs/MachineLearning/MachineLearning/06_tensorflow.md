...
![6.1 咖啡烘培实验 =560x](/machinelearning/two/06-7.png)
...
![6.2 咖啡烘培代码初见 =560x](/machinelearning/two/06-8.png)
...
![6.3 手写数字识别代码初见 =560x](/machinelearning/two/06-9.png)
...
![6.4 数据形式的一些微小差异 =560x](/machinelearning/two/06-10.png)
...
![6.5 咖啡烘培神经网络初搭建 =560x](/machinelearning/two/06-11.png)
...
![6.6 Numpy实现神经网络1 =560x](/machinelearning/two/06-12.png)
...
![6.7 Numpy实现神经网络2 =560x](/machinelearning/two/06-13.png)
...
![6.8 Numpy 和 TensorFlow 的对比 =560x](/machinelearning/two/06-14.png)
...
![6.9 TensorFlow 训练模型完整过程 =560x](/machinelearning/two/06-15.png)
...
![6.10 最常见的三个激活函数 =560x](/machinelearning/two/06-16.png)
...
![6.11 隐藏层的激活函数选择 =560x](/machinelearning/two/06-17.png)
...
![6.12 为什么需要激活函数 =560x](/machinelearning/two/06-18.png)
...
![6.13 多类分类问题 =560x](/machinelearning/two/06-19.png)
...
![6.14 Softmax成本函数 =560x](/machinelearning/two/06-20.png)
...
![6.15 多标签分类1 =560x](/machinelearning/two/06-21.png)
...
![6.16 多标签分类2 =560x](/machinelearning/two/06-22.png)
...
![6.17 梯度下降之adam优化算法 =560x](/machinelearning/two/06-23.png)
...
![6.18 梯度下降之adam优化算法 =560x](/machinelearning/two/06-24.png)
...
![6.19 梯度下降之adam优化算法 =560x](/machinelearning/two/06-25.png)
