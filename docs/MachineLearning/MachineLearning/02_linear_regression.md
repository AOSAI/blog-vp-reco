...
![确定性关系 =360x](/machinelearning/one/02-1.png)

![相关性关系 =360x](/machinelearning/one/02-2.png)
...
![ =560x](/machinelearning/one/02-3.png)
...
![f~w~(x)图例 =360x](/machinelearning/one/02-4.png)

![J(w)图例 =360x](/machinelearning/one/02-5.png)
...
![可视化图例1 =360x](/machinelearning/one/02-6.png)

![可视化图例2 =360x](/machinelearning/one/02-7.png)
...
![梯度下降的形象比喻 =560x](/machinelearning/one/02-8.png)
...
![直击灵魂的演示 =560x](/machinelearning/one/02-9.png)
...
![学习率的意义 =560x](/machinelearning/one/02-10.png)
...
![线性回归梯度下降的推导 =560x](/machinelearning/one/02-11.png)

如果我们使用了平方误差成本函数，得到的图形是一个碗状（bowl shape）的图形，也叫 凹函数（convex function），它只会有一个全局的最小值，如下图所示。

![使用平方误差的几何表示 =560x](/machinelearning/one/02-12.png)
