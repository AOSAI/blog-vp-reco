...
![9.1 分类算法 =360x](/machinelearning/four/09-01.png)

![9.2 聚类算法 =360x](/machinelearning/four/09-02.png)
...
![9.3 聚类算法的应用 =560x](/machinelearning/four/09-03.png)
...
![9.4 K-means原理-1 =560x](/machinelearning/four/09-04.png)

（1）图 9.4 中的红叉和蓝叉，代表随机生成的两个集群的中心位置，它们被称之为**簇质心**。

![9.5 K-means原理-2 =560x](/machinelearning/four/09-05.png)

（2）随后我们分别计算，所有数据和两个簇质心之间的距离，然后进行比较，将靠近红叉的数据标记为红色，将靠近蓝叉的数据标记为蓝色。

![9.6 K-means原理-3 =560x](/machinelearning/four/09-06.png)
...
![9.7 K-means原理-4 =360x](/machinelearning/four/09-07.png)

![9.8 K-means原理-5 =360x](/machinelearning/four/09-08.png)

![9.9 K-means原理-6 =360x](/machinelearning/four/09-09.png)
...
![9.10 K-means算法伪代码 =560x](/machinelearning/four/09-10.png)
...
![9.11 K-means算法适用性 =560x](/machinelearning/four/09-11.png)
...
![9.12 成本函数 =560x](/machinelearning/four/09-12.png)
...
![9.13 移动簇质心 =560x](/machinelearning/four/09-13.png)
...
![9.14 初始化 K-means =560x](/machinelearning/four/09-14.png)
...
![9.15 选择聚类数量 =560x](/machinelearning/four/09-15.png)
...
![9.16 肘部方法 =560x](/machinelearning/four/09-16.png)
...
![9.17 T恤示例的聚类数量划分 =560x](/machinelearning/four/09-17.png)
...
![9.18 异常检测-发动机1 =560x](/machinelearning/four/09-18.png)
...
![9.19 异常检测-发动机2 =560x](/machinelearning/four/09-19.png)
...
![9.20 高斯分布 =560x](/machinelearning/four/09-20.png)
...
![9.21 高斯分布的性质 =560x](/machinelearning/four/09-21.png)
...
![9.22 特征变换拟合高斯分布 =560x](/machinelearning/four/09-22.png)
