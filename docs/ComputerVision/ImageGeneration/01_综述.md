...
![1.1 Inpainting 案例 - Latent Diffusion Model =560x](/cv/ImageGeneration/01_xxx/01_inpainting.png)
...
![1.2 Colorization 案例 - DDColor Model =560x](/cv/ImageGeneration/01_xxx/02_teaser.webp)
...
![1.3 Denoising 案例 - noise2noise Model =560x](/cv/ImageGeneration/01_xxx/03_denoise.png)
...
![1.4 Deblurring 案例 - DeblurDiNAT Model =560x](/cv/ImageGeneration/01_xxx/04_deblurring.jpeg)
...
![1.5 Super-Resolution 案例 - Real-ESRGAN Model =560x](/cv/ImageGeneration/01_xxx/05_sr.jpg)
...
![2.1 Style Transfer 案例 - visual-concept-translator Model =560x](/cv/ImageGeneration/01_xxx/06_style_transfer.jpg)
...
![2.2 I2I Translation 案例 - CycleGAN Model =560x](/cv/ImageGeneration/01_xxx/07_i2i_translation.jpg)
...
![3.1 Image Captioning 案例 - CLIP_prefix_caption Model =560x](/cv/ImageGeneration/01_xxx/08_IC.jpeg)

2. **Dense Captioning**：对图像多个区域生成局部描述，代表数据集为 Visual Genome。

![3.2 Dense Captioning 案例 - Densecap Model =560x](/cv/ImageGeneration/01_xxx/08_DC.png)

3. **Image Paragraph Generation**：复杂图像生成多句段落，强调上下文与细节，代表数据集为 Stanford Image Paragraph。

![3.3 Image Paragraph Generation 案例 - Image2Paragraph Model =560x](/cv/ImageGeneration/01_xxx/08_IPG.png)
...
![3.4 Visual StoryTelling 案例 - (2016) 未公布代码 =560x](/cv/ImageGeneration/01_xxx/09_VS.jpeg)
...
![3.5 Visual Question Answering 案例 - vqa.pytorch model =560x](/cv/ImageGeneration/01_xxx/10_vqa.png)
