...
![2.1 Red通道 =240x](/cv/ImageProcessing/02_xxx/13_lena_R.png)

![2.2 Green通道 =240x](/cv/ImageProcessing/02_xxx/14_lena_G.png)

![2.3 Blue通道 =240x](/cv/ImageProcessing/02_xxx/15_lena_B.png)
...
![2.4 Red合并通道 =240x](/cv/ImageProcessing/02_xxx/16_lena_R.png)

![2.5 Green合并通道 =240x](/cv/ImageProcessing/02_xxx/17_lena_G.png)

![2.6 Blue合并通道 =240x](/cv/ImageProcessing/02_xxx/18_lena_B.png)
...
![2.7 plt中显示单通道-1 =560x](/cv/ImageProcessing/02_xxx/19_plt1.png)

如果要显示单通道像素的颜色强度值，我们只需要把 cmap 的值全部改为 gray 就可以了。

![2.8 plt中显示单通道-2 =560x](/cv/ImageProcessing/02_xxx/20_plt2.png)
...
![2.9 HSV图解1 =240x](/cv/ImageProcessing/02_xxx/21_hsv.webp)

![2.10 HSV图解2 =240x](/cv/ImageProcessing/02_xxx/22_hsv1.png)
...
![2.11 plt 中 RGB 和 HSV 的对比 =560x](/cv/ImageProcessing/02_xxx/23_hsv1.png)
...
![2.12 HSV提取特定颜色 Mask =240x](/cv/ImageProcessing/02_xxx/24_lena1.png)

![2.13 HSV提取特定颜色 Result =240x](/cv/ImageProcessing/02_xxx/24_lena2.png)
...
![2.14 HSV三通道可视化 =560x](/cv/ImageProcessing/02_xxx/25_hsv.png)
...
![2.15 RGB 与 Lab 亮度调整对比 =560x](/cv/ImageProcessing/02_xxx/26_lena1.png)
...
![2.16 RGB 与 Lab 对比度调整对比 =560x](/cv/ImageProcessing/02_xxx/26_lena2.png)
...
![2.17 CHALE - Lab 亮度直方图均衡化 =560x](/cv/ImageProcessing/02_xxx/27_Lab_clahe.png)
...
![2.18 Lab 色彩通道分离1 灰度图 =560x](/cv/ImageProcessing/02_xxx/28_lab_ch1.png)
...
![2.19 Lab 色彩通道分离2 彩色图 =560x](/cv/ImageProcessing/02_xxx/28_lab_ch2.png)
...
![3.1 固定尺寸缩放，长宽比不一致时 =240x](/cv/ImageProcessing/02_xxx/11_lena_scale.png)
...
![3.2 中心裁剪 =240x](/cv/ImageProcessing/02_xxx/10_crop.jpeg)

![3.3 边缘填充 =240x](/cv/ImageProcessing/02_xxx/12_padding.jpeg)
...
![3.4 边缘填充-1 =240x](/cv/ImageProcessing/02_xxx/12_padding_1.jpeg)

![3.5 边缘填充-2 =240x](/cv/ImageProcessing/02_xxx/12_padding_2.jpeg)

![3.6 边缘填充-3 =240x](/cv/ImageProcessing/02_xxx/12_padding_3.jpeg)
...
![3.7 旋转90度 =240x](/cv/ImageProcessing/02_xxx/02_lena_ro90.png)

![3.8 旋转180度 =240x](/cv/ImageProcessing/02_xxx/03_lena_ro180.png)

![3.9 旋转270度 =240x](/cv/ImageProcessing/02_xxx/04_lena_ro270.png)
...
![3.10 旋转45度，无缩放 =240x](/cv/ImageProcessing/02_xxx/05_lena_45.png)

![3.11 旋转200度，缩放0.7 =240x](/cv/ImageProcessing/02_xxx/06_lena_200.png)

![3.12 旋转45度，边界调整 =240x](/cv/ImageProcessing/02_xxx/05_lena_45_1.png)
...
![3.13 水平翻转 =240x](/cv/ImageProcessing/02_xxx/07_lena_flip_h.png)

![3.14 垂直翻转 =240x](/cv/ImageProcessing/02_xxx/08_lena_flip_v.png)

![3.15 水平+垂直翻转 =240x](/cv/ImageProcessing/02_xxx/09_lena_flip_hv.png)
...
![3.16 透视变换-原图 =240x](/cv/ImageProcessing/02_xxx/29_poker1.webp)

![3.17 透视变换-新图 =240x](/cv/ImageProcessing/02_xxx/29_poker2.jpeg)
