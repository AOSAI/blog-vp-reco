...
![子图样例 =500x](/dataFoundry/matplotlib/plt-00-02.png)
...
![ =560x](/dataFoundry/matplotlib/plt-00-04.png)

### 1.4 绘图风格

Matplotlib 在使用的时候有两种风格：面向对象风格（ax）和 pyplot 函数风格。看看同样绘制下方的图例，两种风格的代码有何不同。

![ =560x](/dataFoundry/matplotlib/plt-00-05.png)
...
![正弦函数 =360x](/dataFoundry/matplotlib/plt-01-01.png)

![正弦余弦函数 =360x](/dataFoundry/matplotlib/plt-01-02.png)
...
![线条风格的符号/文字表示 =360x](/dataFoundry/matplotlib/plt-01-03.png)

![线条风格和颜色的合成表示 =360x](/dataFoundry/matplotlib/plt-01-04.png)
...
![标题，名称，标签 =360x](/dataFoundry/matplotlib/plt-01-05.png)

![坐标轴刻度及范围 =360x](/dataFoundry/matplotlib/plt-01-06.png)
...
![去除边框 =360x](/dataFoundry/matplotlib/plt-01-07.png)

![使坐标轴中心点位于0处 =360x](/dataFoundry/matplotlib/plt-01-08.png)
...
![plot()的散点图 =360x](/dataFoundry/matplotlib/plt-01-09.png)

![plot()的散点图加线性函数 =360x](/dataFoundry/matplotlib/plt-01-10.png)
...
![散点图晕染效果 =560x](/dataFoundry/matplotlib/plt-01-11.png)
