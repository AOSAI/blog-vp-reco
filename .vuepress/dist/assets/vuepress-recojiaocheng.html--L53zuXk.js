import{_ as d,c as r,a as i,b as e,d as n,e as l,r as p,o as t}from"./app-knK7nh4Q.js";const c={},o={href:"https://nodejs.org/en/download",target:"_blank",rel:"noopener noreferrer"},v={href:"https://blog.csdn.net/haipheng/article/details/147334004",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.cnblogs.com/jinsulive/p/18771812",target:"_blank",rel:"noopener noreferrer"};function u(b,s){const a=p("ExternalLinkIcon");return t(),r("div",null,[s[9]||(s[9]=i(`<h2 id="_1-node-js-环境配置" tabindex="-1"><a class="header-anchor" href="#_1-node-js-环境配置"><span>1. Node.js 环境配置</span></a></h2><p>我之前使用过 vuepress-theme-hope，不管是 hope 还是现在的 reco，都是基于 vuepress 二次开发的个人博客框架。因此，首先要在电脑中配置 Node.js 环境。</p><p>如果不确定自己电脑中是否已经配置过该环境，windows 中打开 cmd 命令行工具，macOS 打开 Terminal 终端，输入以下指令，如果存在，就会显示 npm / node 的版本号。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">npm -v</span>
<span class="line">node -v</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div>`,4)),e("p",null,[s[1]||(s[1]=n("这里是 Node.js 官网的",-1)),e("a",o,[s[0]||(s[0]=n("下载地址",-1)),l(a)]),s[2]||(s[2]=n("。reco 的 2.x 版本 node 的版本需要大于等于 18。截止 2025 年 8 月，长期稳定版本为 22.18.0，完全符合标准，建议使用 .pkg 的方式进行下载和安装。",-1))]),s[10]||(s[10]=e("h3",{id:"_1-1-windows-系统",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1-1-windows-系统"},[e("span",null,"1.1 Windows 系统")])],-1)),e("p",null,[s[4]||(s[4]=n("win 安装教程的帖子非常多，搜索一下，找个最新的看一看就行。这里给一个目前比较新的安装教程：",-1)),e("a",v,[s[3]||(s[3]=n("CSDN - Windows11 安装 Node.js 及环境配置",-1)),l(a)]),s[5]||(s[5]=n("，安装的几个小建议和过程稍微提一下：",-1))]),s[11]||(s[11]=i(`<ol><li>建议不要安装在 C 盘，选择其他的固态盘安装。</li><li>需要在安装根目录中，新建 node_global 和 node_cache 两个文件夹（可能会遇到没有写入权限的问题），npm 配置 prefix 和 cache 路径参数。</li><li>配置系统环境变量，在高级系统设置中。如果电脑多人使用，就配置到 “用户变量” 里，如果就自己，或者大家都能用，可以直接配置到 “系统变量” 中。</li></ol><h3 id="_1-2-macos-系统" tabindex="-1"><a class="header-anchor" href="#_1-2-macos-系统"><span>1.2 macOS 系统</span></a></h3><p>mac 的步骤和 win 类似，但又有所不同。最基础的是 “修改 npm 的全局安装目录到用户目录”，这样可以避免每次 npm 下载库的时候，都需要 sudo 强行提升权限。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"># 创建一个全局 npm 目录</span>
