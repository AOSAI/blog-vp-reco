export const navbar = [
    ...
    },
    {
      text: "深度学习",
      children: [
        { text: "PyTorch(未整理)", link: "/blogs/DeepLearning/PyTorch/README.md" },
      ],
    },
    {
      text: "计算机视觉",
      children: [
        ...
        { text: "生图模型", link: "/blogs/ComputerVision/ImageGeneration/01_综述" },
      ...
      children: [
        {
          text: 'Reco内置',
          children: [
            { text: "分类", link: '/categories/Blog/1' },
            { text: "标签", link: '/tags/Blog/1' },
