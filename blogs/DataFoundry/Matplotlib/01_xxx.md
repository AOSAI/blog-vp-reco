...
![绘图结构的图像描述](/dataFoundry/matplotlib/plt-00-01.png)
...
![子图样例](/dataFoundry/matplotlib/plt-00-02.png =500x)
...
<!-- ![Artist接口思维导图](/dataFoundry/matplotlib/plt-00-03.png) -->
...
![](/dataFoundry/matplotlib/plt-00-04.png =560x)

### 1.4 绘图风格

Matplotlib 在使用的时候有两种风格：面向对象风格（ax）和 pyplot 函数风格。看看同样绘制下方的图例，两种风格的代码有何不同。

![](/dataFoundry/matplotlib/plt-00-05.png =560x)
...
![正弦函数](/dataFoundry/matplotlib/plt-01-01.png =360x)

![正弦余弦函数](/dataFoundry/matplotlib/plt-01-02.png =360x)
...
![线条风格的符号/文字表示](/dataFoundry/matplotlib/plt-01-03.png =360x)

![线条风格和颜色的合成表示](/dataFoundry/matplotlib/plt-01-04.png =360x)
...
![标题，名称，标签](/dataFoundry/matplotlib/plt-01-05.png =360x)

![坐标轴刻度及范围](/dataFoundry/matplotlib/plt-01-06.png =360x)
...
![去除边框](/dataFoundry/matplotlib/plt-01-07.png =360x)

![使坐标轴中心点位于0处](/dataFoundry/matplotlib/plt-01-08.png =360x)
...
![plot()的散点图](/dataFoundry/matplotlib/plt-01-09.png =360x)

![plot()的散点图加线性函数](/dataFoundry/matplotlib/plt-01-10.png =360x)
...
![散点图晕染效果](/dataFoundry/matplotlib/plt-01-11.png =560x)
